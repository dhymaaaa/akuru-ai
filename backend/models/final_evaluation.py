...
if __name__ == "__main__":
    # Update the path to use the fine-tuned model from the second file
    ...
    try:
        # Initialize evaluator - adding the base model parameter for the fine-tuned model
        print("Initializing evaluator...")
        evaluator = ModelEvaluator(model_path, base_model_name="backend/models/gemma3/dhivehi-gemma-3-1b")
