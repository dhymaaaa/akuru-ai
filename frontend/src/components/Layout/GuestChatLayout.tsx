            ...
            <div className="flex-1 flex flex-col h-screen">
                ...
                <div className="bg-[#292929] py-2 px-3 flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        <NewChatButton onClick={onNewChat} isCollapsed={true} />
                    </div>
                    <div>
                        <button onClick={onLogin} className="bg-[#434343] mr-4 text-white px-10 py-1 rounded-full">
                            Login
                        </button>
                        <button onClick={onSignUp} className="bg-[#1E1E1E] text-white px-10 py-1 rounded-full">
                            Register
                        </button>
                    </div>
                </div>
